...
class CommunityRepository {
  ...
  FutureVoid editCommunity(Community community) async {
    try {
      //It make sure that will return a new community model with any change
      //that are made
  ...
  Stream<List<Community>> searchCommunity(String query) {
    return _communities
        .where(
          ...
          //We will get a -1 error if we donot put null condition
          //here because initially query is empty and the range will
          //be(0,-1) which will give error
